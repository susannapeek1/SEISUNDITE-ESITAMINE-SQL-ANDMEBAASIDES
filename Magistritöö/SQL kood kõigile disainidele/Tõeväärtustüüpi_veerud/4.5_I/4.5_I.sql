START TRANSACTION;
ALTER TABLE tellimus ADD on_makstud BOOLEAN;
UPDATE tellimus SET on_makstud = FALSE;
ALTER TABLE tellimus ALTER COLUMN on_makstud SET NOT NULL;
...
WHEN (NEW.on_ootel<>OLD.on_ootel 
	  ...
	  OR NEW.on_makstud<>OLD.on_makstud)
