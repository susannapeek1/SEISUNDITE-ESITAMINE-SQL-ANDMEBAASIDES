INSERT INTO temporaalsed_veerud_3.tellimus (tellimuse_nr, kohaletoimetamise_aadress, ootel_aeg, tootlemisel_aeg, valja_saadetud_aeg, kohale_toimetatud_aeg, tuhistatud_aeg)
SELECT 
tellimuse_nr,
