INSERT INTO toevaartustuupi_veerud.tellimus (tellimuse_nr, kohaletoimetamise_aadress, on_ootel, on_tootlemisel, on_valja_saadetud, on_kohale_toimetatud, on_tuhistatud, seisundimuudatuse_aeg)
SELECT 
tellimuse_nr,
